...
def model_map(net_name="resnet50"):
    _dicts = {"resnet50": resnet50, "resnet101": resnet101, "resnet152": resnet152}
...
def build_net_resnet(phase, num_classes=2, net_name="resnet50"):
    ...
    model = DSFD(phase, resnet, extras, fem_modules, head_pal1, head_pal2, num_classes)
    return model


if __name__ == "__main__":
    inputs = Variable(torch.randn(1, 3, 640, 640))
    net = build_net_resnet("train", 2, "resnet101")
    out = net(inputs)
