...
optimizer = dict(type="SGD", lr=[0.0005, 5e-05], momentum=0.9, weight_decay=0.0005)
optimizer_config = dict(grad_clip=dict(max_norm=35, norm_type=2))
lr_config = dict(
    policy="step", warmup="linear", warmup_iters=2000, warmup_ratio=0.1, step=[216, 246]
)
total_epochs = 273
